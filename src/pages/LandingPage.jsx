...
const LandingPage = () => {
  ...
  const doctors = [
    ...
    //   image:
    //     '/gads/nov25/patna/Images/Dr Gauri maam.webp',
    ...
    // },
    {
      ...
      image:
        '/gads/nov25/patna/Images/DR DEBILINA ROY.webp',
    ...
    //   location: 'New Patna NCR',
    //   image:
    //     '/gads/nov25/patna/Images/Dr. Lisha Singh.webp',
    // },
    // {
    //   name: 'Dr. Monika Maan',
    //   role: 'IVF Specialist',
    //   experience: 'Experience:12+ years',
    //   location: 'Pitampura, NCR Patna',
    //   image:
    //     '/gads/nov25/patna/Images/Dr. Monika Maan.webp',
    ...
    //   location: 'Faridabad, NCR Patna',
    //   image:
    //     '/gads/nov25/patna/Images/Dr. Beena Upadhyay.webp',
  ...
  const testimonials = [
    {
      stars: 5,
      text:
        'Thanks for Seeds of Innocence Team. Seeds of innocence team ka work bhout hi achha h. Hme first time m hi success mili. Price k according facilities kafi achhi h. special thanks to Dr.',
      videoId: 'xFzDcMwkqTA',
      link: 'https://www.youtube.com/watch?v=xFzDcMwkqTA',
    },
    {
      stars: 5,
      text:
        'It was a great experience to consult Dr. Gauri Ma’am. After getting treatment from SOI we got positive pregnancy. HIGHLY GRATEFUL TO Dr and SOI team.',
      videoId: '-Z1SXqVbt40',
      link: 'https://www.youtube.com/watch?v=-Z1SXqVbt40',
    },
    {
      stars: 5,
      text:
        'Thanks for Seeds of Innocence Team. Seeds of innocence team ka work bhout hi achha h. Hme first time m hi success mili. Price k according facilities kafi achhi h. special thanks to Dr.',
      videoId: 'MemQgDHNsNQ',
      link: 'https://www.youtube.com/watch?v=MemQgDHNsNQ',
    },
    {
      stars: 5,
      text:
      ...
      videoId: 'g7LifHVjOYE',
      link: 'https://www.youtube.com/watch?v=g7LifHVjOYE',
    },
  ]
    ...
    <>
      ...
      <header className="fixed top-0 left-0 right-0 w-full bg-white z-50 shadow-lg">
        <div className="mx-auto max-w-7xl flex items-center justify-start sm:justify-between gap-35 px-2 py-1">
          ...
          <a href="/" className="flex items-center gap-1 sm:gap-2 flex-shrink-0">
            <img
              src="/gads/nov25/patna/Images/SOILogo.webp"
          ...
          <div className="flex flex-col items-start sm:items-center gap-1 w-auto sm:w-[210px] ml-0 sm:ml-0 flex-shrink-0">
            ...
            >
              <span className="absolute left-2 sm:left-3 top-1/2 -translate-y-1/2 inline-flex items-center justify-center rounded-full bg-white shadow">
                <img
                  src="/gads/nov25/patna/Images/whatsapp_PNG20 1.webp"
                  alt="WhatsApp"
      ...
      <div className="pt-[45px] sm:pt-[65px]">
        ...
        <section className="relative hidden sm:block w-full min-h-[500px] sm:h-[480px] lg:h-[620px]" aria-label="Hero">
          {/* Background image */}
          <img
            src="/gads/nov25/patna/Images/Patna1.webp"
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="sm:hidden mb-6">
              ...
              <div ref={serviceRow1Ref} className="flex gap-3 overflow-x-auto pb-2 mb-3 scrollbar-hide" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
                <div className="bg-white rounded-lg p-3 shadow-sm border border-gray-200 text-center flex-shrink-0 w-[140px] transition duration-300 hover:shadow-md group">
                  <div className="w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-2">
                    <img src="/gads/nov25/patna/Images/IUI, IVF & ICSI.webp" alt="IUI, IVF & ICSI" className="w-12 h-12 object-contain" loading="lazy" />
                  </div>
                  <h3 className="text-gray-900 font-medium text-xs leading-tight">IUI, IVF & ICSI</h3>
                </div>
                <div className="bg-white rounded-lg p-3 shadow-sm border border-gray-200 text-center flex-shrink-0 w-[140px] transition duration-300 hover:shadow-md group">
                  <div className="w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-2">
                    <img src="/gads/nov25/patna/Images/Blastocyst.webp" alt="Blastocyst Transfer" className="w-12 h-12 object-contain" loading="lazy" />
                  </div>
                  <h3 className="text-gray-900 font-medium text-xs leading-tight">Blastocyst Transfer</h3>
                </div>
                <div className="bg-white rounded-lg p-3 shadow-sm border border-gray-200 text-center flex-shrink-0 w-[140px] transition duration-300 hover:shadow-md group">
                  <div className="w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-2">
                    <img src="/gads/nov25/patna/Images/Cryopreservation.webp" alt="Cryopreservation" className="w-12 h-12 object-contain" loading="lazy" />
                  </div>
                ...
                <div className="bg-white rounded-lg p-3 shadow-sm border border-gray-200 text-center flex-shrink-0 w-[140px] transition duration-300 hover:shadow-md group">
                  <div className="w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-2">
                    <img src="/gads/nov25/patna/Images/PRP & Ovarian.webp" alt="PRP & Ovarian Rejuvenation" className="w-12 h-12 object-contain" loading="lazy" />
                  </div>
              ...
              <div ref={serviceRow2Ref} className="flex gap-3 overflow-x-auto pb-2 scrollbar-hide" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
                <div className="bg-white rounded-lg p-3 shadow-sm border border-gray-200 text-center flex-shrink-0 w-[140px] transition duration-300 hover:shadow-md group">
                  <div className="w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-2">
                    <img src="/gads/nov25/patna/Images/Genetic testing.webp" alt="Genetic Testing" className="w-12 h-12 object-contain" loading="lazy" />
                  </div>
                ...
                <div className="bg-white rounded-lg p-3 shadow-sm border border-gray-200 text-center flex-shrink-0 w-[140px] transition duration-300 hover:shadow-md group">
                  <div className="w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-2">
                    <img src="/gads/nov25/patna/Images/Genetic.webp" alt="Genetic Counseling" className="w-12 h-12 object-contain" loading="lazy" />
                  </div>
                  <h3 className="text-gray-900 font-medium text-xs leading-tight">Genetic Counseling</h3>
                </div>
                <div className="bg-white rounded-lg p-3 shadow-sm border border-gray-200 text-center flex-shrink-0 w-[140px] transition duration-300 hover:shadow-md group">
                  <div className="w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-2">
                    <img src="/gads/nov25/patna/Images/TESA PESA.webp" alt="TESA/PESA" className="w-12 h-12 object-contain" loading="lazy" />
                  </div>
                  <h3 className="text-gray-900 font-medium text-xs leading-tight">TESA/PESA</h3>
                </div>
                <div className="bg-white rounded-lg p-3 shadow-sm border border-gray-200 text-center flex-shrink-0 w-[140px] transition duration-300 hover:shadow-md group">
                  <div className="w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-2">
                    <img src="/gads/nov25/patna/Images/Laparoscopy &.webp" alt="Laparoscopy & Hysteroscopy" className="w-12 h-12 object-contain" />
                  </div>
            ...
            <div className="hidden sm:grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8 sm:mb-10 lg:mb-12">
              ...
              <div className="bg-white rounded-sm p-4 sm:p-6 shadow-sm border border-gray-200 text-center transition duration-300 ease-out hover:shadow-xl hover:-translate-y-1 hover:scale-[1.04] group">
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 transition-transform duration-300 group-hover:rotate-12 group-hover:scale-110">
                  <img
                    src="/gads/nov25/patna/Images/IUI, IVF & ICSI.webp"
                    alt="IUI, IVF & ICSI"
              ...
              <div className="bg-white rounded-sm p-4 sm:p-6 shadow-sm border border-gray-200 text-center transition duration-300 ease-out hover:shadow-xl hover:-translate-y-1 hover:scale-[1.04] group">
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 transition-transform duration-300 group-hover:rotate-12 group-hover:scale-110">
                  <img
                    src="/gads/nov25/patna/Images/Blastocyst.webp"
              ...
              <div className="bg-white rounded-sm p-4 sm:p-6 shadow-sm border border-gray-200 text-center transition duration-300 ease-out hover:shadow-xl hover:-translate-y-1 hover:scale-[1.04] group">
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 transition-transform duration-300 group-hover:rotate-12 group-hover:scale-110">
                  <img
                    src="/gads/nov25/patna/Images/Cryopreservation.webp"
              ...
              <div className="bg-white rounded-sm p-4 sm:p-6 shadow-sm border border-gray-200 text-center transition duration-300 ease-out hover:shadow-xl hover:-translate-y-1 hover:scale-[1.04] group">
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 transition-transform duration-300 group-hover:rotate-12 group-hover:scale-110">
                  <img
                    src="/gads/nov25/patna/Images/PRP & Ovarian.webp"
              ...
              <div className="bg-white rounded-sm p-4 sm:p-6 shadow-sm border border-gray-200 text-center transition duration-300 ease-out hover:shadow-xl hover:-translate-y-1 hover:scale-[1.04] group">
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 transition-transform duration-300 group-hover:rotate-12 group-hover:scale-110">
                  <img
                    src="/gads/nov25/patna/Images/Genetic testing.webp"
                    alt="Genetic Testing"
                    className="w-16 h-16 sm:w-20 sm:h-20 object-contain"
                    loading="lazy"
                  />
              ...
              <div className="bg-white rounded-sm p-4 sm:p-6 shadow-sm border border-gray-200 text-center transition duration-300 ease-out hover:shadow-xl hover:-translate-y-1 hover:scale-[1.04] group">
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                  <img
                    src="/gads/nov25/patna/Images/Genetic.webp"
              ...
              <div className="bg-white rounded-sm p-4 sm:p-6 shadow-sm border border-gray-200 text-center transition duration-300 ease-out hover:shadow-xl hover:-translate-y-1 hover:scale-[1.04] group">
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 transition-transform duration-300 group-hover:rotate-12 group-hover:scale-110">
                  <img
                    src="/gads/nov25/patna/Images/TESA PESA.webp"
                    alt="TESA/PESA"
                    className="w-16 h-16 sm:w-20 sm:h-20 object-contain"
                    loading="lazy"
                  />
              ...
              <div className="bg-white rounded-sm p-4 sm:p-6 shadow-sm border border-gray-200 text-center transition duration-300 ease-out hover:shadow-xl hover:-translate-y-1 hover:scale-[1.04] group">
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 transition-transform duration-300 group-hover:rotate-12 group-hover:scale-110">
                  <img
                    src="/gads/nov25/patna/Images/Laparoscopy &.webp"
        ...
        <section className="w-full py-8 sm:py-12 lg:py-16">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            {/* Main Heading */}
            <h2 className="text-center text-2xl sm:text-3xl lg:text-4xl font-bold text-red-600 mb-4 sm:mb-6">
              Best IVF Specialists & IVF Doctors in Patna
            </h2>
              ...
              <div className="grid grid-cols-1 gap-3">
                {doctors.map((doc) => (
                  ...
                  >
                    ...
                    <h3 className="mt-2 text-red-600 font-bold tracking-wide text-lg leading-tight">{doc.name}</h3>
                    <p className="mt-0.5 text-gray-700 text-[16px]">{doc.role}</p>
                    <p className="text-gray-600 text-[16px]">{doc.experience}</p>
                    <p className="mt-0.5 text-gray-900 font-semibold text-[16px] uppercase">{doc.location}</p>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="hidden sm:grid grid-cols-1 mt-20 sm:grid-cols-2 lg:grid-cols-1 gap-6 sm:gap-8">
              {doctors.map((doc) => (
                <div
                  key={doc.name}
                  className="flex flex-col items-center text-center group transition-all duration-300"
                ...
                {[
                  {
                    ...
                    icon: (
                      <img src="/gads/nov25/patna/Images/08.webp" alt="35+ IVF Centres" className="h-10 w-10 object-contain" loading="lazy" />
                    ),
                  },
                  {
                    ...
                    icon: (
                      <img src="/gads/nov25/patna/Images/01.webp" alt="20,000+ Healthy Babies" className="h-10 w-10 object-contain" loading="lazy" />
                    ),
                  },
                  {
                    ...
                    icon: (
                      <img src="/gads/nov25/patna/Images/03.webp" alt="Upto 78% Success Rate" className="h-10 w-10 object-contain" loading="lazy" />
                    ),
                  },
                  {
                    ...
                    icon: (
                      <img src="/gads/nov25/patna/Images/06.webp" alt="30+ Certified Trained Clinicians" className="h-10 w-10 object-contain" loading="lazy" />
                    ),
                  },
                ].map((f, idx) => (
                  <div
                ...
                {[
                  {
                    ...
                    icon: (
                      <img src="/gads/nov25/patna/Images/02.webp" alt="Affordable IVF Care" className="h-10 w-10 object-contain" loading="lazy" />
                    ),
                  },
                  {
                    ...
                    icon: (
                      <img src="/gads/nov25/patna/Images/04.webp" alt="Fetal Medicine" className="h-10 w-10 object-contain" loading="lazy" />
                    ),
                  },
                  {
                    ...
                    icon: (
                      <img src="/gads/nov25/patna/Images/05.webp" alt="Expert Fertility Counsellor & Clinical Geneticist" className="h-10 w-10 object-contain" loading="lazy" />
                    ),
                  },
                  {
                    ...
                    icon: (
                      <img src="/gads/nov25/patna/Images/07.webp" alt="In-House Genetic Lab" className="h-10 w-10 object-contain" loading="lazy" />
                    ),
                  },
                ].map((f, idx) => (
                  <div
              ...
              {[
                {
                  ...
                  desc:
                    "With over 35 IVF centres across the National and International, Seeds of Innocens brings fertility care closer to you. Whether you're in a metro or a smaller city, expert help is never far away. Visit your nearest centre and take the first step toward parenthood with us.",
                  icon: (
                    <img src="/gads/nov25/patna/Images/08.webp" alt="35+ IVF Centres" className="h-14 w-14 object-contain" loading="lazy" />
                  ),
                },
                {
                  title: '20,000+ Healthy Babies',
                  desc:
                    'At Seeds of Innocens, we are proud to have helped over 20,000 families welcome healthy babies into the world. Our commitment to quality fertility care and personalised treatment has made us a trusted name in IVF.',
                  icon: (
                    <img src="/gads/nov25/patna/Images/01.webp" alt="20,000+ Healthy Babies" className="h-14 w-14 object-contain" loading="lazy" />
                  ),
                },
                {
                  title: 'Upto 78% Success Rate',
                  desc:
                    'We maintain an impressive IVF success rate of 78%, higher than the average. Our advanced lab technology and individualised treatment plans make this possible. We believe in transparency, trust, and results that matter.',
                  icon: (
                    <img src="/gads/nov25/patna/Images/03.webp" alt="Upto 78% Success Rate" className="h-14 w-14 object-contain" loading="lazy" />
                  ),
                },
                {
                  title: '30+ Certified Trained Clinicians',
                  desc:
                    'Our team includes over 30 certified and highly trained fertility specialists and embryologists. With years of experience and global expertise, we offer world-class treatment and compassionate care.',
                  icon: (
                    <img src="/gads/nov25/patna/Images/06.webp" alt="30+ Certified Trained Clinicians" className="h-14 w-14 object-contain" loading="lazy" />
                  ),
                },
                {
                  title: 'Affordable IVF Care',
                  desc:
                    'We provide affordable IVF treatment and offer quality services to patients, with customised packages and financing options to make your journey easier.',
                  icon: (
                    <img src="/gads/nov25/patna/Images/02.webp" alt="Affordable IVF Care" className="h-14 w-14 object-contain" loading="lazy" />
                  ),
                },
                {
                  title: 'Fetal Medicine',
                  desc:
                    'We offer fetal medicine services including ultrasound scans, fetal echocardiography, and diagnostic procedures like amniocentesis and CVS for comprehensive prenatal care.',
                  icon: (
                    <img src="/gads/nov25/patna/Images/04.webp" alt="Fetal Medicine" className="h-14 w-14 object-contain" loading="lazy" />
                  ),
                },
                {
                  title: 'Expert Fertility Counsellor & Clinical Geneticist',
                  desc:
                    'Genetic counselors evaluate family histories and identify potential genetic risks that could affect reproductive outcomes, guiding you with options and implications of results.',
                  icon: (
                    <img src="/gads/nov25/patna/Images/05.webp" alt="Expert Fertility Counsellor & Clinical Geneticist" className="h-14 w-14 object-contain" loading="lazy" />
                  ),
                },
                {
                  title: 'In-House Genetic Lab',
                  desc:
                    'We are the first IVF centre in India to establish an in-house genetic lab with testing services including PGT-A which increases the success rate of the IVF process.',
                  icon: (
                    <img src="/gads/nov25/patna/Images/07.webp" alt="In-House Genetic Lab" className="h-14 w-14 object-contain" loading="lazy" />
                  ),
                },
              ].map((f, idx) => (
                <div
        ...
        <section className="w-full bg-gray-100 py-8 sm:py-12 lg:py-16">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            {/* Main Heading */}
            <h2 className="text-center text-2xl sm:text-3xl lg:text-4xl font-bold text-red-600 mb-4 sm:mb-6">
              About Seeds of Innocens IVF Centre Patna
            </h2>
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-8 p-4 sm:p-8">
              ...
              <div className="w-full max-w-xl flex-shrink-0">
                <img
                  src="/gads/nov25/patna/Images/patna.webp"
                  alt="Seeds of Innocens IVF Centre Patna building"
            ...
            <div className="flex flex-col lg:flex-row gap-8">
              ...
              <div className="w-full lg:w-1/2 flex flex-col">
                <div className=" p-5 sm:p-6">
                  <h3 className="font-bold text-xl sm:text-2xl text-gray-900 leading-snug">Seeds of Innocens - Best IVF Centre in Patna | Fertility Clinics</h3>
                  <div className="mt-4 space-y-3">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <p className="text-base sm:text-lg text-gray-900">
                        <span className="font-semibold">Address:</span> Pillar no: 38, Jagmano Shree Complex, Bailey Rd, Samanpura, Khajpura, Patna, Bihar 800014
                      </p>
                    </div> 
                  </div>
                  <div className="mt-5 flex flex-wrap gap-3">
                    <a href="https://www.google.com/maps/place/Seeds+of+Innocens+IVF+Centre+Patna+%7C+IVF+Hospital+In+Patna,+Bihar/@25.6051862,85.0787355,17z/data=!3m1!4b1!4m6!3m5!1s0x39ed57c796d9157f:0xca0cf0c718b0d862!8m2!3d25.6051814!4d85.0813104!16s%2Fg%2F11h3mrr6c5?entry=ttu&g_ep=EgoyMDI1MTEwOS4wIKXMDSoASAFQAw%3D%3D" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 bg-red-600 text-white px-4 py-2 rounded-md text-sm font-semibold hover:bg-red-700 transition-colors">
